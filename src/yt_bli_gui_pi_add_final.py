...
def download_videos():
    ...
    for url in urls:
        ...
        try:
            ...
            with open(log_file_path, "a") as log_file:
                ...
                video_title = None  # 用于存储当前下载视频的标题
                for line in process.stdout:
                    ...
                    # 提取标题信息
                    if "title:" in line:
                        title_match = re.search(r"title: (.+)", line, re.IGNORECASE)
                        if title_match:
            ...
            if process.returncode == 0:
                ...
                success_count += 1
                if video_title:
                    success_names.append(video_title)
    ...
    log_text.insert(tk.END, f"Total successful downloads: {success_count}\n")
    log_text.insert(tk.END, "Successfully downloaded videos:\n")
